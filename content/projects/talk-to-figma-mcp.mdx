...
<div style={{textAlign: 'center', marginTop: '20px'}}>
  <a href="https://github.com/grab/cursor-talk-to-figma-mcp" target="_blank" style={{display: 'inline-flex', alignItems: 'center', padding: '10px 20px', backgroundColor: '#333333', color: 'white', textDecoration: 'none', borderRadius: '5px', fontWeight: 'bold'}}>
    <img src="https://github.githubassets.com/images/modules/logos_page/GitHub-Mark.png" alt="GitHub Logo" height="24" style={{maxHeight: '24px', marginRight: '10px'}} />
...
<div style={{textAlign: 'center', margin: '2rem 0'}}>
  <strong>Download Figma MCP Magic Desktop App</strong>
  <br /><br />
  ...
  <br /><br />
  <a href="https://apps.apple.com/kr/app/figma-mcp-magic/id6751596669" target="_blank">Mac App Store</a> | <a href="https://apps.microsoft.com/detail/xpfg2vd5zd6ph9" target="_blank">Microsoft Store</a>
</div>
