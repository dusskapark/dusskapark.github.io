...
tags: ["Side Project", "Android", "BLE Beacon", "Firebase", "Mobile App"]
...
featured_image: /images/projects/2015-bobplanet/step4_1mb.png
accent_color: '#4C60E6'
...
<iframe src="//www.slideshare.net/slideshow/embed_code/key/i34MRy1UT32DnV" width="595" height="485" frameBorder="0" marginWidth="0" marginHeight="0" scrolling="no" style={{border: '1px solid #CCC', borderWidth: '1px', marginBottom: '5px', maxWidth: '100%'}} allowFullScreen></iframe>
