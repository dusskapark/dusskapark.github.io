...
tags: ["Side Project", "Mobile Web", "React", "QR Code", "E-commerce"]
date: 2018-12-01 00:00:00
description: Orderbook(모두의 주문) is a service that customers order directly from the table with a mobile QR code.
accent_color: '#4C60E6'
featured_image: /images/projects/2018-orderbook/logostory2018-002.png
# gallery_images:
...
<a href="https://drive.google.com/open?id=1CDudLoe4XduV3w6YqFFZDdFro8UYA877" className="button--fill" target="_blank">See more detail</a>
...
<a href="http://zpl.io/aBqe1dO" className="button--fill" target="_blank">See more detail</a>
