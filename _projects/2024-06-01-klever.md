...
{% include post-components/quote.html
   ...
   text = "<span style='font-size: 24px; background-color: #333; color: #fff; padding: 2px 4px;'>Without the need for recruiting users</span> or <span style='font-size: 24px; background-color: #333; color: #fff; padding: 2px 4px;'>spending extensive time on interviews</span>, designers could gain insights by observing AI-generated user behaviors within seconds."
%}
<br/>
<br/>
...
<div class="timeline-item">
### Understanding the Challenge: AppAgent's Core Mechanism
...
<div class="timeline-item">
### First Steps: Experimenting with Figma API
...
<div class="timeline-item">
### Breaking Through: The Selenium Solution
...
<div class="timeline-item">
### The Prototype: Our First Working Demo
...
<div class="timeline-item">
### Community Validation: Friends of Figma Seoul
...
<div class="timeline-item">
### The Evolution: From AppAgent to Klever
...
So we decided to give this new tool a new identity. That’s how ‘Klever’ was born. Klever is a Figma plugin product that inherits the core functionality of AppAgent while providing a more user-friendly and intuitive interface for designers.

{::options parse_block_html="false" /}
{% include post-components/gallery.html
   columns = 1
   full_width = false
   images = "../images/projects/2024-klever/6_logo_1_1.png"
   caption="A new identity for Klever Figma Plugin"
%}
{::options parse_block_html="true" /}
</div>

<div class="timeline-item">
### The Final Push: Building the Plugin
...
Converting AppAgent’s Python scripts to TypeScript for use in the Figma plugin required a lot of code refactoring.

**Development of the UIs:**
While the original AppAgent was mainly targeted at engineers or AI researchers and essentially had no UI, Klever needed to create an intuitive and easy-to-use frontend screen for designers.

**Utilizing Figma Plugin API:**
Most importantly, since we couldn’t use Selenium to control the prototype in the limited environment of the Figma plugin, we had to find a way to control it using the Figma plugin API.
...
<div style="text-align: center; margin-top: 20px;">
  <a href="https://www.figma.com/community/plugin/1383457529531594701/klever-instant-usability-testing" target="_blank" style="display: inline-flex; align-items: center; padding: 10px 20px; background-color: #333333; color: white; text-decoration: none; border-radius: 5px; font-weight: bold;">
...
**Case 1: Discovering Hidden Interactions**
...
**Case 2: Identifying UI Element Ambiguity**

![img](https://miro.medium.com/v2/resize:fit:5760/1*R92frAL_eyND6l4ngawrSQ.png)

![img](https://miro.medium.com/v2/resize:fit:5760/1*b9KQ1pvy5ce_aTYcvOBZ8Q.png)
...
**Case 3: Predicting Hidden Features**

![img](https://miro.medium.com/v2/resize:fit:5760/1*n9f4URU4nmqVM7tH7Y6eKA.png)

![img](https://miro.medium.com/v2/resize:fit:5760/1*r0gibKgVw5UDjVB5NoKdQg.png)
...
# **InfCon 2024 and Next Steps**

Shortly after releasing the Figma plugin, an unexpected opportunity came our way. Kim Ji-hong from [Design Spectrum](https://medium.com/u/d906e16642cf) and Hong Yeon-ui from [Inflearn](https://medium.com/u/785769823235), who had been following our project with interest, invited us to speak at [InfCon 2024](https://www.inflearn.com/conf/infcon-2024/).

We are truly grateful that this small project, which only two designers put together with determination, was given the chance to be showcased at such a large conference.
...
![img](https://miro.medium.com/v2/resize:fit:8064/1*lPUDAWMZkKVfwkow5TzX5w.jpeg)

![img](https://miro.medium.com/v2/resize:fit:8064/1*AD3da5UcO307nG2e92eSvg.jpeg)

![img](https://miro.medium.com/v2/resize:fit:8064/1*4ljxfd9GmCx6I6XfEOEY-Q.jpeg)

![img](https://miro.medium.com/v2/resize:fit:3000/1*ep6QVLJmOvZZACXEI4a6UQ.jpeg)

InfCon24 recap: We never imagined the room would be packed for our 5 PM session on a Friday… Thank you so much.
...
Thankfully, a few people have suggested new approaches based on this open source, and we are conducting experiments together. We will continue to create more updates together in the future.

![Prototype of the Figma plugin via integrating with Python Flask server approach](https://miro.medium.com/v2/resize:fit:1400/0*5iw8-jVN15UXUtoD)

Prototype of the Figma plugin using a Flask server approach ([Code](https://github.com/FigmaAI/AppAgent))
...
![img](https://miro.medium.com/v2/resize:fit:1400/1*-UZ5ve7olp0-7jfcevuUEQ.jpeg)
