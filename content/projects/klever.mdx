...
{% include store-badges.html
   url1="https://apps.apple.com/us/app/klever-instance-ut/id6754501208"
   url2="xp8brb9spkfrsw"
   app_name="Klever Instance UT"
   title="Download Klever Desktop App"
   description="Klever Desktop is now available on the stores below. Download and start your AI-powered usability testing journey today!"
   full_width=false
%}
